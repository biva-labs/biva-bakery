                ...
                <tbody>
                  ...
                  <tr>
                    <td style="background:linear-gradient(135deg, #002a3a 0%, #004d5c 100%);padding:40px 30px;text-align:center;">
                      ...
                      <p style="margin:10px 0 0 0;color:#fbbf24;font-size:14px;font-weight:500;letter-spacing:1px;">HOTELS & BAKERY</p>
                    </td>
                  </tr>
                  ...
                  <tr>
                    <td style="padding:40px 30px;">
                      ...
                      <p style="margin:0 0 30px 0;color:#4b5563;font-size:16px;line-height:1.6;font-family:'Segoe UI',Arial,sans-serif;">
                        Thank you for choosing Biva! We're thrilled to confirm your event booking. Your payment of <strong style="color:#fb923c;">₹${amount}</strong> has been successfully processed.
                      </p>

                      <!-- Event Image -->
                      ${image ? `
                      <div style="margin:0 0 30px 0;text-align:center;border-radius:12px;overflow:hidden;border:3px solid #fb923c;">
                        <img src="${image}" alt="Event" style="width:100%;max-width:400px;height:auto;display:block;margin:0 auto;" />
                      </div>
                      ` : ''}
                      ...
                      <div style="background-color:#ffffff;border:2px solid #e5e7eb;border-radius:12px;overflow:hidden;margin:0 0 30px 0;">
                        ...
                        <div style="padding:24px;">
                          <table width="100%" cellpadding="8" cellspacing="0" style="font-family:'Segoe UI',Arial,sans-serif;">
                            ...
                            <tr>
                              <td style="color:#6b7280;font-size:14px;padding:12px 0;border-bottom:1px solid #e5e7eb;">
                                <strong style="color:#002a3a;">Event Name:</strong>
                              </td>
                              <td style="color:#1f2937;font-size:14px;padding:12px 0;border-bottom:1px solid #e5e7eb;text-align:right;">
                                ${event_name}
                              </td>
                            ...
                            <tr>
                              <td style="color:#6b7280;font-size:14px;padding:12px 0;border-bottom:1px solid #e5e7eb;">
                                <strong style="color:#002a3a;">Group Name:</strong>
                              </td>
                              <td style="color:#1f2937;font-size:14px;padding:12px 0;border-bottom:1px solid #e5e7eb;text-align:right;">
                                ${group_name}
                              </td>
                            ...
                            <tr>
                              <td style="color:#6b7280;font-size:14px;padding:12px 0;border-bottom:1px solid #e5e7eb;">
                                <strong style="color:#002a3a;">Date:</strong>
                              </td>
                              <td style="color:#1f2937;font-size:14px;padding:12px 0;border-bottom:1px solid #e5e7eb;text-align:right;">
                                ${date}
                              </td>
                            ...
                            <tr>
                              <td style="color:#6b7280;font-size:14px;padding:12px 0;border-bottom:1px solid #e5e7eb;">
                                <strong style="color:#002a3a;">Time:</strong>
                              </td>
                              <td style="color:#1f2937;font-size:14px;padding:12px 0;border-bottom:1px solid #e5e7eb;text-align:right;">
                                ${time}
                              </td>
                  ...
                  <tr>
                    <td style="background-color:#002a3a;padding:24px 30px;text-align:center;">
                      <p style="margin:0 0 8px 0;color:#ffffff;font-size:12px;font-family:'Segoe UI',Arial,sans-serif;">
                        © ${new Date().getFullYear()} Biva Hotels & Bakery. All rights reserved.
                      </p>
