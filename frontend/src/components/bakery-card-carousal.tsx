...
import type { BakeryProduct } from "../../data/bakery-data";
            ...
            {products.map((product) => (
              ...
              >
                <div className="h-full rounded-xl overflow-hidden bg-white shadow-md">
                  <div className="bg-white rounded-2xl shadow-lg overflow-hidden hover:scale-105 transform transition duration-300">
                    <img
                      src={product.image}
                      alt={product.name}
                    ...
                    <div className="p-5 flex flex-col justify-between h-40">
                      <div>
                        <h3 className="text-xl font-bold text-[#002a3a] ">
                          {product.name}
                        </h3>
