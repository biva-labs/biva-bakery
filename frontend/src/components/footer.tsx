  ...
  return (
    <footer className="bg-[#fefce8] text-[#5c3d2e] py-16" id="footer">
      <div className="max-w-7xl mx-auto px-6 lg:px-8 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
        ...
        {/* Quick Links - Alignment changed to always be left-aligned (items-start, text-left) */}
        <div className="flex flex-col items-start text-left">
          <h3 className="text-lg font-semibold mb-4">Quick Links</h3>
          <div className="grid grid-cols-2 gap-x-4 gap-y-3">
            {QUICK_LINKS["navigation"].map(({ href, label, icon: Icon }) => (
              <Link
                key={href}
                to={href}
        ...
        {/* Terms & Conditions - Alignment changed to always be left-aligned (items-start, text-left) */}
        <div className="flex flex-col items-start text-left">
        ...
        {/* Contact & Support - Alignment changed to always be left-aligned (items-start, text-left) */}
        <div className="flex flex-col items-start text-left">
