// components/ui/veg-food.jsx
import React from 'react';

export default function VegetarianFood() {
  return (
    <div className="w-full mt-16 mb-10 mx-auto">
      <div className="relative w-full aspect-[4/3] rounded-2xl overflow-hidden shadow-[0_0_40px_rgba(40,167,69,0.6)]">
        <video
