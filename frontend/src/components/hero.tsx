...
export default function Hero({
	...
	const titleWrapperClasses = clsx(
		...
		isBakeryPage
			? "left-1/2 transform -translate-x-1/2 w-full text-center"
			: "left-0",
	);
	...
	return (
		<div
			className={clsx(
				"relative w-screen -mt-14 right-4",
				heightClasses ?? "h-[40vh] lg:h-[60vh]",
			)}
		>
			...
			<div className={titleWrapperClasses}>
				<h1
					className={`text-2xl md:text-4xl outfit font-extrabold lg:text-5xl text-white leading-tight`}
				>
					{title}
				</h1>
