...
export default function FoodCourtHero() {
  return (
    <div className="relative w-full h-[30vh] md:h-[40vh] lg:h-[60vh] overflow-hidden">
      ...
      <div className="absolute bottom-0 right-0 p-3 md:p-10 z-20 flex flex-col items-end space-y-2">
        <div className="text-white text-sm md:text-xl leading-snug">
          <div>Book your table in advance</div>
          <div className="text-right">for upcoming events</div>
        </div>
