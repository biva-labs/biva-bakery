	...
	return (
		<>
			...
			<div className="w-full px-0 lg:px-0 mt-16 mb-10">
				<div className="relative w-full aspect-[4/3] md:aspect-video lg:aspect-auto lg:h-[70vh] xl:h-[68vh] rounded-2xl overflow-hidden shadow-[0_0_40px_rgba(255,223,0,0.6)]">
					<video
						src={media}
			...
			{/* New Video Section */}
			<div className="w-full px-0 lg:px-0 mt-16 mb-10">
				<div className="relative w-full aspect-[4/3] md:aspect-video lg:aspect-auto lg:h-[62vh] xl:h-[68vh] rounded-2xl overflow-hidden shadow-[0_0_40px_rgba(255,223,0,0.6)]">
					<video
						src="/bar.mp4"
						className="w-full h-full object-cover"
						autoPlay
